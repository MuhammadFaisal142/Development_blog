        ...
        <div class="row blog-entries element-animate">
            ...
            <div class="col-md-12 col-lg-4 sidebar">
                ...
                <div class="sidebar-box">
                    <div class="bio text-center" style="background: aliceblue;">
                        <img style="
                        height: 150px;
                        width: 150px;
                        ...
                        <div class="bio-body">
                            ...
                            <p style="padding: 5px">{!! $post->user->description !!}</p>
                ...
                <div class="sidebar-box">
                    ...
                    <ul class="categories">
                        ...
                        <li><a href="{{ route('website.post', ['slug' => $post->slug]) }}"">{{ $category->name }} <span>(12)</span> </a></li>
                            @endforeach
                        </ul>
                    </div>
                    <!-- END sidebar-box -->
                    ...
                    <div class=" sidebar-box">
                                ...
                                <ul class="tags">
                                    @foreach ($tags as $tag)
                                    <li><a
                                            href="{{ route('website.tag', ['slug' => $tag->slug]) }}">{{ $tag->name }}</a>
                                    </li>
                                    @endforeach
                                </ul>
                </div>
...
<script>
    ...
    s.src = 'https://laravel-blog-4ta7zs57n1.disqus.com/embed.js';
