...
<body>
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-4 site-logo">
                        <a href="{{ route('website')}}" class="text-black h2 mb-0">Development Blog</a>
                    </div>

                    <div class="col-8 text-right">
                        <nav class="site-navigation" role="navigation">
                            <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block mb-0 p-0">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <p>
                            ...
                            <div class="mb-0">Developed By Faisal on <a href="{{ route('website') }}">Laravel Blog
                                    Development </a>Tutorial Series</div>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script id="dsq-count-scr" src="//laravel-blog-4ta7zs57n1.disqus.com/count.js" async></script>
    @yield('script')
    ...
    {{-- <script async src="https://www.example.com/path/to/gtag.js?id=UA-23581568-13"></script> --}}
    <script>
