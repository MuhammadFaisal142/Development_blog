                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="twitter" name="twitter" value="{{ $setting->twitter }}"
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="reddit" name="reddit" value="{{ $setting->reddit }}"
                                                        class="form-control" placeholder="reddit url">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="address" id="address"
                                                        class="form-control no-tinymce " rows="1"
